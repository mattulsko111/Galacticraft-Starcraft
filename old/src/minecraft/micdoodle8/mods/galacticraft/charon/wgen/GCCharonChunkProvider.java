 ...
 *
 */
public class GCCharonChunkProvider extends ChunkProviderGenerate
{
	...
	public GCCharonBiomeDecorator biomedecoratorplanet = new GCCharonBiomeDecorator(GCCharonBiomeGenBase.CharonFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCCharonBiomeGenBase.CharonFlat};
	...
	public GCCharonChunkProvider(World par1World, long par2, boolean par4)
	{
		...
		GCCharonChunkProvider.giantCaveLocations = new ArrayList();
		GCCharonChunkProvider.creeperDungeonLocations = new ArrayList();
	}
