 ...
 *
 */
public class GCCharonWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCCharonWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCCharonBiomeGenBase.CharonFlat);
    }

    public GCCharonWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCCharonWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCCharonBiomeGenBase.CharonFlat;
    }
