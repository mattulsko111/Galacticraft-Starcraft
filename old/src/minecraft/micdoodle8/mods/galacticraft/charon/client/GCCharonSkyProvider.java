...
public class GCCharonSkyProvider extends IRenderHandler
{
	public int starGLCallList = GLAllocation.generateDisplayLists(3); 
	public int glSkyList;
	public int glSkyList2;
	
	public GCCharonSkyProvider() 
	{
		GL11.glPushMatrix();
	...
	{
		GCCharonWorldProvider gcProvider = null;
		
		if (world.provider instanceof GCCharonWorldProvider)
		{
			gcProvider = (GCCharonWorldProvider)world.provider;
		}
