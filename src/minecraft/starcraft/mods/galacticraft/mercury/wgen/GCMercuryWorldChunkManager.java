...
public class GCMercuryWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCMercuryWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCMercuryBiomeGenBase.MercuryFlat);
    }

    public GCMercuryWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCMercuryWorldChunkManager(World par1World, float par2)
    {
