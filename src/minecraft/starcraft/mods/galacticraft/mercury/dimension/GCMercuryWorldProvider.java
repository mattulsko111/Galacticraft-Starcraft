package starcraft.mods.galacticraft.mercury.dimension;

import micdoodle8.mods.galacticraft.API.IGalacticraftWorldProvider;
import starcraft.mods.galacticraft.mercury.GCMercuryConfigManager;
import starcraft.mods.galacticraft.mercury.wgen.GCMercuryChunkProvider;
import starcraft.mods.galacticraft.mercury.wgen.GCMercuryWorldChunkManager;
import starcraft.mods.galacticraft.mercury.GCMercuryConfigManager;
import starcraft.mods.galacticraft.mercury.wgen.GCMercuryChunkProvider;
import starcraft.mods.galacticraft.mercury.wgen.GCMercuryWorldChunkManager;
...
public class GCMercuryWorldProvider extends WorldProvider implements IGalacticraftWorldProvider
{
    private final float[] colorsSunriseSunset = new float[4];
    
	public GCMercuryWorldProvider()
    {
        this.setDimension(GCMercuryConfigManager.dimensionIDMercury);
        this.dimensionId = GCMercuryConfigManager.dimensionIDMercury;
    }
    ...
    {
        this.worldChunkMgr = new GCMercuryWorldChunkManager(this.worldObj, 0F);
    }
