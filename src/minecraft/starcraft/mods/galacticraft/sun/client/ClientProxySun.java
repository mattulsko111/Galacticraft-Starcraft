...
import starcraft.mods.galacticraft.sun.CommonProxySun;
...
public class ClientProxySun extends CommonProxySun implements IGalacticraftSubModClient
{
	...
	{
		lang = new GCCoreLocalization("starcraft/mods/galacticraft/sun/client");
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
    		ClientProxySun.getCurrentTime = System.currentTimeMillis();
            ...
            {
    			if (player != null && player.worldObj.provider instanceof GCSunWorldProvider && !player.capabilities.isFlying && !minecraft.isGamePaused) 
    			{
    			...
    			if (world != null && world.provider instanceof GCSunWorldProvider)
    			{
    				if (world.provider.getSkyRenderer() == null)
                    {
    					world.provider.setSkyRenderer(new GCSunSkyProvider());
                    }
    			}
            }
        }
        ...
        {
            return "Galacticraft Sun Client";
        }
	...
	{
		return ClientProxySun.lang;
	}

	@Override
	public String getPlanetSpriteDirectory() 
	{
		return "/starcraft/mods/galacticraft/sun/client/planets/";
	}
