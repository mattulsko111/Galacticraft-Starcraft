...
public class GCSunWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCSunWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCSunBiomeGenBase.SunFlat);
    }

    public GCSunWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCSunWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCSunBiomeGenBase.SunFlat;
    }
