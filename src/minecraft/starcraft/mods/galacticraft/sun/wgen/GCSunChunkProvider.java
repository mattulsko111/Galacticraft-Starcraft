package starcraft.mods.galacticraft.sun.wgen;
...
public class GCSunChunkProvider extends ChunkProviderGenerate
{
	...
	public GCSunBiomeDecorator biomedecoratorplanet = new GCSunBiomeDecorator(GCSunBiomeGenBase.SunFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCSunBiomeGenBase.SunFlat};
	...
	public GCSunChunkProvider(World par1World, long par2, boolean par4)
	{
		...
		GCSunChunkProvider.giantCaveLocations = new ArrayList();
		GCSunChunkProvider.creeperDungeonLocations = new ArrayList();
	}
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                ...
                                {
                                	idArray[var43 += var44] = (short)Block.waterStill.blockID;
                                }
                                else
                                {
