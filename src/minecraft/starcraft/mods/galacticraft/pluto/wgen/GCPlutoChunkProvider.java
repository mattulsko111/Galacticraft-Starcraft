...
public class GCPlutoChunkProvider extends ChunkProviderGenerate
{
	...
	public GCPlutoBiomeDecorator biomedecoratorplanet = new GCPlutoBiomeDecorator(GCPlutoBiomeGenBase.PlutoFlat);
	...
	private BiomeGenBase[] biomesForGeneration = {GCPlutoBiomeGenBase.PlutoFlat};
	...
	public GCPlutoChunkProvider(World par1World, long par2, boolean par4)
	{
		...
		GCPlutoChunkProvider.giantCaveLocations = new ArrayList();
		GCPlutoChunkProvider.creeperDungeonLocations = new ArrayList();
	}
