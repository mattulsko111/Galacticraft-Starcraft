...
public class GCPlutoWorldChunkManager extends WorldChunkManager
{
    ...
    protected GCPlutoWorldChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(GCPlutoBiomeGenBase.PlutoFlat);
    }

    public GCPlutoWorldChunkManager(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public GCPlutoWorldChunkManager(World par1World, float par2)
    {
    ...
    {
        return GCPlutoBiomeGenBase.PlutoFlat;
    }
