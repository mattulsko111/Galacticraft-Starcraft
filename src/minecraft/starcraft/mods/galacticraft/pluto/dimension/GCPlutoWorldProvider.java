package starcraft.mods.galacticraft.pluto.dimension;

import micdoodle8.mods.galacticraft.API.IGalacticraftWorldProvider;
import starcraft.mods.galacticraft.pluto.GCPlutoConfigManager;
import starcraft.mods.galacticraft.pluto.wgen.GCPlutoChunkProvider;
import starcraft.mods.galacticraft.pluto.wgen.GCPlutoWorldChunkManager;
import starcraft.mods.galacticraft.pluto.GCPlutoConfigManager;
import starcraft.mods.galacticraft.pluto.wgen.GCPlutoChunkProvider;
import starcraft.mods.galacticraft.pluto.wgen.GCPlutoWorldChunkManager;
...
public class GCPlutoWorldProvider extends WorldProvider implements IGalacticraftWorldProvider
{
    private final float[] colorsSunriseSunset = new float[4];
    
	public GCPlutoWorldProvider()
    {
        this.setDimension(GCPlutoConfigManager.dimensionIDPluto);
        this.dimensionId = GCPlutoConfigManager.dimensionIDPluto;
    }
    ...
    {
        this.worldChunkMgr = new GCPlutoWorldChunkManager(this.worldObj, 0F);
    }
...
//        return var3 == GCMarsBlocks.marsGrass.blockID;
    ...
    {
    	return "DIM" + GCPlutoConfigManager.dimensionIDPluto;
    }
