...
import starcraft.mods.galacticraft.pluto.dimension.GCPlutoWorldProvider;
import starcraft.mods.galacticraft.pluto.GalacticraftPluto;
...
public class GalacticraftPluto implements IGalacticraftSubMod
{
	...
	@SidedProxy(clientSide = "starcraft.mods.galacticraft.pluto.client.ClientProxyPluto", serverSide = "starcraft.mods.galacticraft.pluto.CommonProxyPluto")
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		new GCPlutoConfigManager(new File(event.getModConfigurationDirectory(), "Galacticraft/pluto.conf"));
	...
	{
		DimensionManager.registerProviderType(GCPlutoConfigManager.dimensionIDPluto, GCPlutoWorldProvider.class, true);
		DimensionManager.registerDimension(GCPlutoConfigManager.dimensionIDPluto, GCPlutoConfigManager.dimensionIDPluto);
	...
	{
		 NetworkRegistry.instance().registerChannel(new ServerPacketHandler(), "GcPluto", Side.SERVER);
	}
