...
import starcraft.mods.galacticraft.pluto.CommonProxyPluto;
...
public class ClientProxyPluto extends CommonProxyPluto implements IGalacticraftSubModClient
{
	...
	{
		lang = new GCCoreLocalization("starcraft/mods/galacticraft/pluto/client");
	...
	public void init(FMLInitializationEvent event)
	{
        ...
        NetworkRegistry.instance().registerChannel(new ClientPacketHandler(), "GcPluto", Side.CLIENT);
	}
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
    		ClientProxyPluto.getCurrentTime = System.currentTimeMillis();
            ...
            {
    			if (player != null && player.worldObj.provider instanceof GCPlutoWorldProvider && !player.capabilities.isFlying && !minecraft.isGamePaused) 
    			{
    			...
    			if (world != null && world.provider instanceof GCPlutoWorldProvider)
    			{
