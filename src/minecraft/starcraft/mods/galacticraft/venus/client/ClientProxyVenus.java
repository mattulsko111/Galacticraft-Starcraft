...
import starcraft.mods.galacticraft.venus.CommonProxyVenus;
...
public class ClientProxyVenus extends CommonProxyVenus implements IGalacticraftSubModClient
{
	...
	{
		lang = new GCCoreLocalization("starcraft/mods/galacticraft/venus/client");
    ...
    public static class TickHandlerClient implements ITickHandler
    {
        ...
        {
    		ClientProxyVenus.getCurrentTime = System.currentTimeMillis();
            ...
            {
    			if (player != null && player.worldObj.provider instanceof GCVenusWorldProvider && !player.capabilities.isFlying && !minecraft.isGamePaused) 
    			{
    			...
    			if (world != null && world.provider instanceof GCVenusWorldProvider)
    			{
	...
	{
		return ClientProxyVenus.lang;
	}

	@Override
	public String getPlanetSpriteDirectory() 
	{
		return "/starcraft/mods/galacticraft/venus/client/planets/";
	}
